          ...
          <div className="flex flex-col gap-6 w-full text-[15px] text-[#1d1d1f] dark:text-gray-200">
            ...
            <div className="border-b border-[#d2d2d7] dark:border-neutral-800 pb-6">
              <ul className="list-none space-y-3">
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <div>
                    <span className="font-semibold">Front ports:</span> Two
                    Thunderbolt 5 ports, SDXC card slot
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <div>
                    <span className="font-semibold">Back ports:</span> Four
                    Thunderbolt 5 ports, two USB-A ports, HDMI port, 10Gb
            ...
            <div className="bg-[#f5f5f7] dark:bg-neutral-900 rounded-2xl p-6 mt-4 flex flex-col gap-4">
              <div className="flex items-start gap-3">
                <svg
                  className="w-6 h-6 text-gray-700 dark:text-gray-300 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
